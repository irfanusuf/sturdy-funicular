                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                            ...
                            <img src= {product && product.productImgUrls && product.productImgUrls[0]} alt= {product && product.name} width={500} />
                        </div>
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="product__details__text">
                                ...
                                <div className="product__details__price">Rs {product && product.price} /=</div>
